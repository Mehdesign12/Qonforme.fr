...
export function LandingHero() {
  ...
  return (
    <div className="bg-white">
      ...
      {/* ═══════════════════════════════════════════════════════════
          HERO — Aurora background + structure Acme
      ═══════════════════════════════════════════════════════════ */}
      <AuroraBackground
        className="min-h-0 h-auto py-12 md:py-20 lg:py-28 bg-white"
        showRadialGradient={true}
      >
        <main className="relative z-10 mx-auto w-full max-w-5xl px-4">
