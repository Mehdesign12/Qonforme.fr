...
export default function PricingSelector() {
  ...
  function handleSelectPlan(planId: PlanId) {
    ...
    // Navigation directe vers la page checkout dédiée
      ...
      <div className="grid grid-cols-1 sm:grid-cols-2 gap-5">
        {plans.map((plan) => {
          ...
          return (
            <div
              key={plan.id}
              className={`relative rounded-2xl border-2 p-6 flex flex-col transition-shadow bg-white ${
                isPro
            ...
            >
              ...
              <button
                ...
                className={`w-full py-3 px-4 rounded-xl font-semibold text-sm transition-all flex items-center justify-center gap-2 disabled:opacity-70 disabled:cursor-not-allowed ${
                  isPro
