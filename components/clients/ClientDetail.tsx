...
import { ArrowLeft, Pencil, Plus, Loader2, Building2, Mail, Phone, MapPin, Receipt } from "lucide-react"
  ...
  if (!client) {
    return (
      <div className="py-16 text-center">
        ...
        <Link href="/clients" className="text-[#2563EB] text-sm hover:underline mt-2 inline-block">
          ← Retour aux clients
        </Link>
      </div>
    )
    ...
    <div className="space-y-6">
      ...
      <div className="flex items-center justify-between">
        <div className="flex items-center gap-3">
          ...
          <div>
            <h1 className="text-xl font-bold text-[#0F172A]">{client.name}</h1>
        ...
        <div className="flex gap-2">
          {!editing ? (
            ...
            <>
              <Button variant="outline" size="sm" onClick={() => { setEditing(false); setForm(client) }}>
                Annuler
              </Button>
              ...
              <div className="space-y-3">
                {client.email && (
                  <div className="flex items-center gap-2 text-sm">
                    ...
                    <a href={`mailto:${client.email}`} className="text-[#2563EB] hover:underline">{client.email}</a>
                  </div>
                )}
                {client.phone && (
                  <div className="flex items-center gap-2 text-sm">
      ...
      <div className="bg-white rounded-xl border border-[#FEE2E2] p-5">
        ...
        <p className="text-xs text-slate-500 mb-3">
          L&apos;archivage masque le client de la liste. Les factures associées sont conservées.
        </p>
        <Button
          variant="outline"
          size="sm"
