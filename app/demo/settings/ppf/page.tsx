...
export default function DemoPPFSettingsPage() {
  return (
    <div className="max-w-2xl space-y-6 animate-fade-in">
      <div className="flex items-start gap-4 p-5 rounded-xl border bg-[#FEF3C7] dark:bg-[#451a03]/20 border-[#FCD34D] dark:border-[#92400E]/40">
        <AlertCircle className="w-5 h-5 text-[#D97706] mt-0.5 shrink-0" />
        <div>
          <p className="font-semibold text-sm text-[#92400E] dark:text-[#FCD34D]">Transmission non configurée</p>
          <p className="text-xs mt-1 text-[#92400E] dark:text-[#FCD34D]/80">
        ...
        <div className="space-y-3">
          <div>
            ...
            <input
              ...
              disabled
              className="mt-1 w-full px-3 py-2 text-sm border border-[#E2E8F0] dark:border-[#1E3A5F] rounded-lg bg-slate-50 dark:bg-[#162032] font-mono text-slate-400 cursor-not-allowed"
            />
          </div>
          <div>
