...
export default function EditQuotePage() {
  ...
  const [form, setForm] = useState<FormState>({
    client_id: "", issue_date: "", valid_until: "", notes: "", lines: [newLine()],
  })
  ...
  const submit = async (action: "draft" | "send") => {
    ...
    try {
      ...
      toast.success(action === "send" ? "Devis envoyé !" : "Brouillon sauvegardé !")
  ...
  return (
    <div className="max-w-4xl space-y-6 animate-fade-in">
      ...
      <div className="flex items-center gap-3">
        ...
        <div>
          <h1 className="text-xl font-bold text-[#0F172A]">Modifier {quoteNumber}</h1>
      ...
      <div className="flex flex-wrap items-center gap-3 pb-8">
        ...
        <Button
          className="bg-[#0f9457] hover:bg-[#0a7a47] text-white gap-1.5 ml-auto"
